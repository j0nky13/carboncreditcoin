  ...
  return (
    <section className="bg-dark py-12 text-white text-center">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-3xl font-bold text-primary mb-4">🌱 Trees Planted by CO2TAX</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 justify-items-center">
          <div className="bg-gray-900 p-6 rounded-xl shadow-md w-full">
            ...
            <p className="text-3xl font-extrabold text-primary">${volume.toLocaleString()}</p>
          </div>
          <div className="bg-gray-900 p-6 rounded-xl shadow-md w-full">
            <p className="text-sm text-gray-400 mb-1">Trees Committed</p>
            <p className="text-3xl font-extrabold text-primary">{trees.toLocaleString()} 🌳</p>
          </div>
        </div>
      </div>
    </section>
