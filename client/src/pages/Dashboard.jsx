...
// <h2 className="text-2xl font-bold mt-10 mb-4">Welcome back, {user?.displayName || user?.email || 'Anonymous'}!</h2>            <p className="text-gray-400">Here's a summary of your activity on CarbonChain.</p>
...
export default function Dashboard() {
  ...
  if (user === null) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-[#0e0f11] text-gray-400">
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case 'overview':
        return (
          <div className="text-center">
            <h2 className="text-2xl font-bold mt-10 mb-4">Welcome back, {user.displayName || user.email || 'Anonymous'}!</h2>
