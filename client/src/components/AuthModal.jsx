...
export default function AuthModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-gray-900 text-white p-8 rounded-2xl shadow-2xl w-full max-w-md text-center">
        <h1 className="text-2xl font-bold text-lime-400 mb-2">Welcome to Carbon Credit Coin</h1>
        <p className="text-sm text-gray-400 mb-6">Login to access your dashboard, merch, and ICO tools.</p>
        ...
        <button onClick={onClose} className="text-sm text-lime-400 hover:underline mt-6">
          ← Back to homepage
        </button>
      </div>
    </div>
